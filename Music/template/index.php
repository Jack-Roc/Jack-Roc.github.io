...
<head>
    <meta charset="UTF-8">
    <title>懒耗子云音乐 - 多站合一音乐搜索,音乐在线试听 - By Mouse</title>
    <meta name="renderer" content="webkit">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="Cache-Control" content="no-transform">
    <meta http-equiv="Cache-Control" content="no-siteapp">
    <meta name="viewport" content="width=device-width,initial-scale=1,maximum-scale=1,user-scalable=no">
    <meta name="author" content="music.886la.cc">
    ...
    <meta name="description" content="Mouse特制多站合一音乐搜索解决方案，可搜索试听网易云音乐、QQ音乐、酷狗音乐、酷我音乐、虾米音乐、百度音乐、一听音乐、咪咕音乐、荔枝FM、蜻蜓FM、喜马拉雅FM、全民K歌、5sing原创翻唱音乐。">
    ...
    <link rel="canonical" href="http://music.886la.cc/">
...
<body>
    ...
    <section class="am-g about">
        <div class="am-container am-margin-vertical-xl">
            <header class="am-padding-vertical">
                <h2 class="about-title about-color">懒耗子云音乐</h2>
                <p class="am-text-center">懒耗子特制多站合一音乐搜索解决方案</p>
            </header>
            <hr>
    ...
    <footer class="footer">
        <p class="am-text-sm">v<?php echo MC_VERSION; ?>&nbsp;&copy;&nbsp;<?php echo date('Y'); ?>&nbsp;<a href="http://music.886la.cc/" target="_blank" rel="author">音乐下载</a>&nbsp;<a href="http://www.886la.cc/" target="_blank">意见反馈</a>&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
    </footer>
